...
public class NetworkUtils {
    ...
    public static ArrayList<Movie> fetchData(String url) throws IOException {
        ...
        try {
            ...
            URL new_url = new URL("https://www.themealdb.com/api/json/v1/1/categories.php"); //create a url from a String
    ...
    public static void parseJson(String data, ArrayList<Movie> list){
        ...
        try {
            ...
            for (int i = 0; i < resArray.length(); i++) {
                ...
                movie.setId(jsonObject.getLong("idCategory"));

                movie.setOriginalTitle(jsonObject.getString("strCategory"));
                movie.setBackdropPath(jsonObject.getString("strCategoryThumb"));
                movie.setOverview(jsonObject.getString("strCategoryDescription"));

                movie.setPosterPath(jsonObject.getString("strCategoryThumb"));
